  ...
  return (
    <section className="w-full flex items-center flex-col title_section">
      <h1 className="text-center">
        ...
        <span className="text-center ">Discover Places From Around The World</span>
      </h1>
      ...
      <form className="flex flex-col items-center md:w-10/12 mt-10" onSubmit={handleSubmit}>
        <label className="text-lg">Search for a city:</label>
        <input type="text" placeholder="Search" className="px-3 py-2 md:w-full bg-zinc-200 border shadow-xl border-slate-500 placeholder-slate-500 focus:outline-none focus:border-sky-600 focus:ring-cian-500 focus:bg-zinc-100 block rounded-md sm:text-sm focus:ring-1" value={input} onChange={(event) => setInput(event.target.value)}/>
