  ...
  return (
    <section className="w-full flex items-center flex-col title_section">
      ...
      <form className="flex flex-col items-center md:w-10/12 mt-10" onSubmit={handleSubmit}>
        ...
        <input type="text" placeholder="Search" className="px-3 py-2 md:w-full bg-zinc-200 border shadow-xl border-slate-500 placeholder-slate-500 focus:outline-none focus:border-sky-500 focus:ring-cian-500 focus:bg-zinc-100 block rounded-md sm:text-sm focus:ring-1 focus:shadow-lg focus:shadow-sky-500" value={input} onChange={(event) => setInput(event.target.value)}/>
